...
public:
   SpectatorBackend(GGPOSessionCallbacks *cb, ISteamNetworkingMessages* steamNetMessages, const char *gamename, int num_players, int input_size, SteamNetworkingIdentity& hostid);
